        ...
        <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between">
          <a href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <div>
              ...
              <span className="text-[9px] text-slate-500 font-bold uppercase block leading-none">
                {currentUser.role === 'gestao' ? 'Gestão' : 'Professor / Servidor'}
              </span>
            </div>
          </a>
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-xs font-bold text-slate-500 hover:text-slate-700 bg-slate-100 px-3.5 py-1.5 rounded-full border border-slate-200 transition-colors cursor-pointer"
            >
              Sair
            </button>
          </div>
